# -*- coding: utf-8 -*-
#
# django-sitemessage documentation build configuration file.
#
...
copyright = u'2014-2023, Igor `idle sign` Starikov'
...
htmlhelp_basename = 'django-sitemessagedoc'
...
latex_documents = [
  ('index', 'django-sitemessage.tex', u'django-sitemessage Documentation',
...
man_pages = [
    ('index', 'django-sitemessage', u'django-sitemessage Documentation',
