...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'sitemessage_message', 'sender_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'Dispatch.recipient'
        db.alter_column(u'sitemessage_dispatch', 'recipient_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):

        # Changing field 'Message.sender'
        db.alter_column(u'sitemessage_message', 'sender_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['apps.User'], null=True))

        # Changing field 'Dispatch.recipient'
        db.alter_column(u'sitemessage_dispatch', 'recipient_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['apps.User'], null=True))
